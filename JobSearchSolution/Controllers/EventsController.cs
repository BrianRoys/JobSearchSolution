...
namespace JobSearchSolution.Controllers
{
    public class EventsController : Controller
    {
        ...
        {
            var events = db.Event.Include(e => e.EventType).Include(e => e.User);
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,Type,Date,Description,Results")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,Type,Date,Description,Results")] Event @event)
        {
            if (ModelState.IsValid)
            {
